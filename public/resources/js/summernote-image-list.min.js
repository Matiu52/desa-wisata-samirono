    ...
    $.extend($.summernote.plugins, {
        imageList: function (context) {
            ...
            var defaultImageListOptions = {
                ...
                spinnerHtml:
                    '<span class="fa fa-spinner fa-spin" style="font-size: 100px; line-height: 100px; margin-left: calc(50% - 50px)"></span>',
                endpoint: "",
                fullUrlPrefix: "",
                thumbUrlPrefix: "",
            };
            var imageListOptions =
                typeof options.imageList === "undefined"
                    ? {}
                    : options.imageList;
            for (var propertyName in defaultImageListOptions) {
                if (imageListOptions.hasOwnProperty(propertyName) === !1) {
                    imageListOptions[propertyName] =
                        defaultImageListOptions[propertyName];
                }
            }
            ...
            this.showDialog = function () {
                return $.Deferred(function (deferred) {
                    ui.onDialogShown(self.$dialog, function () {
                        ...
                        self.$dialog
                            .find(".image-list-content")
                            .html(imageListOptions.spinnerHtml);
                        $.get(
                            ...
                            var thumbUrlPrefix =
                                imageListOptions.thumbUrlPrefix;
                            content.push(
