...
<script>
    $(document).ready(function() {
        ...
        $("#search-input").on("keyup", function() {
            ...
            if (keyword) {
                fetch_data("{{ route('tour-packages.index') }}", 1, keyword, '#table-tour-package');
            } else {
                fetch_data("{{ route('tour-packages.index') }}", 1, '', '#table-tour-package');
            }
        });
        $(document).on('click', '.pagination a', function(event) {
            ...
            fetch_data("{{ route('tour-packages.index') }}", page, keyword, '#table-tour-package');
        });
    });
</script>
