    ...
    <x-app-layout>
        <x-slot name="header">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                {{ __('Silahkan Buat Paket Wisata, ' . Auth::user()->name . '!') }}
            </h2>
        </x-slot>
        ...
        <div class="my-4 h-auto bg-gray-50/50">
            ...
            <div class="p-4 2xl:ml-80 place-items-center">
                <h1 class="text-3xl font-bold mb-6">Buat Paket Wisata Baru</h1>
                <form action="{{ route('tour-packages.store') }}" method="POST">
                    @include('admin.tour-packages.components.form-package', ['btnText' => 'Buat Paket'])
                </form>
